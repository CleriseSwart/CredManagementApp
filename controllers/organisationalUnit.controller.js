...
exports.populate = function (req, res){
    const OU = new OrganisationalUnitModel(
        {
            ...
            "divisions": [
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "Finance",
                            "repoEmail": "finance@email.com",
                            "repoUsername": "finance",
                ...
                },
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "Marketing",
                            "repoEmail": "marketing@email.com",
                            "repoUsername": "marketing",
                            "repoPassword": "password"
                        }
                    ]
                },
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "Research",
                            "repoEmail": "research@email.com",
                            "repoUsername": "research",
                            "repoPassword": "password"
                        }
                    ]
                },
                ...
                },
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "CS",
                            "repoEmail": "cs@email.com",
                            "repoUsername": "customer support",
                            "repoPassword": "password"
                        }
                    ]
                }, 
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "Operations",
                            "repoEmail": "operations@email.com",
                            "repoUsername": "operations",
                            "repoPassword": "password"
                        }
                    ]
                },
                ...
                },
                {
                    ...
                    "credentialRepos": [
                        {
                            "repoName": "Compliance",
                            "repoEmail": "compliance@email.com",
                            "repoUsername": "compliance",
                            "repoPassword": "password"
                        }
                    ]
                }, 
                {
                    "divisionName": "Analytics",
                    "divisionUsers": [],
                    "credentialRepos": [
                        {
                            "repoName": "Analytics",
                            "repoEmail": "analytics@email.com",
                            "repoUsername": "analytics",
                            "repoPassword": "password"
                        }
                    ]
                }
    ...
    OU.save(function (err, data) {
        if (err) {
            customResponse = {
                message: 'Error creating ou',
                successKey: false,
                data: err
            }
            res.send(customResponse);
...
exports.assignToNewOU = async function (req, res) {
    ...
    try {
        ...
        if ((decoded.role == 'admin')) {
            ...
            // Else (i.e. if the user is not admin), send custom response with access denied.
            customResponse = {
